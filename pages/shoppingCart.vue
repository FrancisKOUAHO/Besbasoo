    ...
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        <div class="flex justify-between border-b pb-8">
          ...
          <h2 class="font-semibold text-2xl">3 éléments</h2>
        </div>
      ...
      <div id="summary" class="w-1/4 px-8 py-10">
        ...
        <div class="flex justify-between mt-10 mb-5">
          <span class="font-semibold text-sm uppercase">3 Articles</span>
          <span class="font-semibold text-sm">590$</span>
        </div>
        <div>
          <label class="font-medium inline-block mb-3 text-sm uppercase">Expédition</label>
        ...
        <div class="border-t mt-8">
          ...
          <button class="bg-yellow-500 font-semibold hover:bg-yellow-600 py-3 text-sm text-white uppercase w-full">
            Passer la commande
          </button>
        </div>
      </div>
