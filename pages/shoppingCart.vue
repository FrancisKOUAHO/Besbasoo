      ...
      <div class="flex-1">
        ...
        <div class="my-4 mt-6 -mx-2 lg:flex">
          <div class="lg:px-2 lg:w-1/2">
            ...
            <div class="p-4">
              <p class="mb-4 italic">Si vous avez un code promo, veuillez le saisir dans la case ci-dessous </p>
              <div class="justify-center md:flex">
                <form action="" method="POST">
                  <div class="flex items-center w-full h-13 pl-3 bg-white bg-gray-100 border rounded-full">
                    <input name="code" id="coupon" placeholder="Apply coupon" value="90off"
                    ...
                    <button type="submit" class="text-sm flex items-center px-3 py-1 text-white bg-gray-800 rounded-full outline-none md:px-4 hover:bg-gray-700 focus:outline-none active:outline-none">
                      ...
                      <span class="font-medium">Appliquer le coupon</span>
                    </button>
                  </div>
                </form>
              </div>
            ...
            <div class="p-4 mt-6 bg-gray-100 rounded-full">
              <h1 class="ml-2 font-bold uppercase">Instructions pour le vendeur</h1>
            </div>
            <div class="p-4">
          ...
          <div class="lg:px-2 lg:w-1/2">
            ...
            <div class="p-4">
              <p class="mb-6 italic">Les frais de livraison et les frais supplémentaires sont calculés en fonction des valeurs que vous avez saisies </p>
              ...
              <nuxt-link :to="{name: 'selectPayment'}">
