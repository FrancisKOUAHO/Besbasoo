  ...
  <div class="min-h-screen min-w-screen flex items-center justify-center bg-gray-200 mobile-view-bg-color">
   ...
   <div class="flex flex-col">
      <div class="py-6 px-8 text-left">
        ...
        <h2  class="text-left  mt-1.5 mobile-text-color vous-e-n">Vous étes nouveau ? <br/> </h2>
        <div class="mt-3">
      ...
      <div class="flex flex-col  px-8 space-y-5 bg-gray-275">
           ...
           <div class="flex flex-wrap items-stretch w-full mb-4 relative h-15 bg-white items-center rounded mb-6 pr-10">
            ...
            />
            <div class="flex -mr-px justify-center w-12 p-4">
               <span  @click="cshow = !cshow" :class="{'hidden': !cshow, 'block':cshow }" class="flex items-center leading-normal bg-white px-3 border-0 rounded rounded-r-none text-2xl text-gray-600" >
                    <i class="fas fa-eye"></i>

                 </span>
                  <span   @click="cshow = !cshow" :class="{'block': !cshow, 'hidden':cshow }" class="flex items-center leading-normal bg-white px-3 border-0 rounded rounded-r-none text-2xl text-gray-600" >
                    <i class="fas fa-eye-slash"></i>
