...
.slider-completely {
  ...
  .vue-slick-carousel {
    ...
    .cross-shadow-ribbon:before {
      ...
      width: 0;
      height: 0;
      border-bottom: 20px solid #ab0202;
